...
const COLORS = {
  ...
  EDGE: "rgba(207, 207, 207, 0.5)", // Lighter gray for edges
  BG_NODE: "rgba(216, 216, 216, 0.6)", // Semi-transparent dark gray for nodes
  BG_EDGE: "rgba(202, 202, 202, 0.3)", // Dark gray for edges
};
...
export default AnimatedKnowledgeGraphDark;
